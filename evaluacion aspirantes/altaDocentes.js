javascript: (() => {
    ...
    let evaluacion = document.querySelector("[name='evaluacion'");
    let entrevista = document.querySelector("[name='res_entrevista'");
    let exani = document.querySelector("[name='res_exani'");
    let propedeutico = document.querySelector("[name='res_propedeutico'");

    let datosAlumno = prompt("Pega los datos del alumno separados por comas (evaluacion,entrevista,exani,cursoPropedeutico)").split(",");

    if (datosAlumno[0] == "ADMITIDO"){
        evaluacion.value = "1"
    };

    entrevista.value = datosAlumno[1];
    exani.value = datosAlumno[2];
    propedeutico.value = datosAlumno[3];
